...
RegisterNetEvent('jd_crafting:setup')
AddEventHandler('jd_crafting:setup', function()
                        ...
                        options = {
                            {
                                ...
                                event = 'jd_crafting:menu',
                                onSelect = function()
                                    TriggerEvent("jd_crafting:menu", name)
                                end,
                                distance = 1,
                            }
                        }
...
RegisterNetEvent('jd_crafting:menu')
AddEventHandler('jd_crafting:menu', function(craftingType)
    ...
    for _, craftingOption in ipairs(craftingData.items) do
        local option = {
            ...
            onSelect = function()
                TriggerServerEvent('jd_crafting:giveitems', craftingType, craftingOption)
            end,
        }
...
lib.callback.register('jd_crafting:serverprogress', function(src, text, time)
...
CreateThread(function()
    TriggerEvent('jd_crafting:setup')
end)
